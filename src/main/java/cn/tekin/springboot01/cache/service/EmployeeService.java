...
import cn.tekin.springboot01.cache.mapper.EmployeeMapper;
...
public class EmployeeService {
     ...
     * sync：是否使用异步模式, 异步模式不支持 unless
     */

    @Cacheable(cacheNames = {"emp"}, key = "#root.args[0]+#root.methodName", condition = "#id>0", unless = "#result == null")
    public Employee getEmp(int id) {
        System.out.println("员工" + id + "查询");
